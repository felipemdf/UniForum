<template>
  <!-- Filters -->
  <!-- Start coding here -->
  <div class="relative bg-white border-gray-200 shadow rounded mb-4">
  ...
  <div class="relative overflow-hidden">
    <div class="flex items-center justify-between py-4 px-2 flex-row">
      <div class="inline-flex w-full flex-row gap-4">
